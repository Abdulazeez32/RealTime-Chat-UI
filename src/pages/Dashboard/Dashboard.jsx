...
export default function RealtimeChatWithStats() {
  ...
  const connections = useMemo(() => {
    ...
    if (Array.isArray(connectionsData?.data)) {
  ...
  const unreadMessageCount = useMemo(() => {
    ...
    if (typeof unreadData?.data === "number") {
      return unreadData.data;
    }
            ...
            <div className="bg-white rounded-3xl border border-violet-100 shadow-[0_20px_60px_rgba(76,29,149,0.18)] overflow-hidden">
              ...
              <div className="p-4 border-b border-violet-100 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-black text-[#27213a]">
                      Notifications
                    </h3>
              ...
              <div className="max-h-[390px] overflow-y-auto">
                ...
                {notificationsLoading ? (
                  <div className="p-8 text-center">
                    ...
                    <p className="text-xs text-[#91879d] mt-3">
                  ...
                  <div className="p-10 text-center">
                    ...
                    <h4 className="text-sm font-black text-[#33283f] mt-4">
                      No notifications
                    </h4>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <h1 className="text-lg font-black text-[#241b35]">
                      Messages
                    </h1>

                    <p className="text-[11px] text-[#8c839b]">
                      Stay connected
                    </p>
            ...
            <div className="flex-1 overflow-y-auto px-2 pb-3">
              ...
              groupsLoading ? (
                ...
                <div className="h-full flex flex-col items-center justify-center text-center px-6">
                  ...
                  <h3 className="mt-4 text-sm font-black text-[#2b2238]">
                    No conversations
                  </h3>

                  <p className="text-xs text-[#92889e] mt-1">
                    Your friends and groups will
                    appear here.
                  </p>
            ...
            <div className="border-t border-violet-100 p-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <div className="bg-violet-50 rounded-xl p-2 text-center">
                  ...
                  <p className="text-sm font-black text-[#2d2438]">
                    {connections.length}
                  </p>

                  <span className="text-[9px] text-[#8d8499]">
                    Friends
                  </span>
            ...
            {!activeConversation ? (
              ...
              <div className="flex-1 flex items-center justify-center bg-[#fdfcff]">
                ...
                <div className="text-center max-w-sm">
                  ...
                  <h2 className="text-2xl font-black text-[#292039] mt-7">
                    Your conversations
                  </h2>

                  <p className="text-sm text-[#91879d] mt-2 leading-relaxed">
                    Select a friend or group from
                    the left to start a real-time
                    conversation.
                  </p>
                  ...
                  <div className="flex items-start gap-2 mb-5">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-[9px] text-[#aaa1b2]">
                          10:42 AM
                        </span>
                  ...
                  >
                    ...
                    <div className="flex-1 bg-[#f7f4ff] border border-violet-100 rounded-2xl px-3 py-2 focus-within:border-violet-400 transition">
                      ...
                      <div className="flex items-center justify-between mt-1">
                        ...
                        <span className="text-[9px] text-[#aaa0b0]">
                          Enter to send
                        </span>
